...
class Tiered_index:
    ...
    def convert_to_tiered_index(
        ...
        for term in current_index.keys():
            s=0
            for doc in current_index[term]:
                s=s+current_index[term][doc]
            if s>first_tier_threshold:
                first_tier[term]=current_index[term]
            elif first_tier_threshold>=s>second_tier_threshold:
                second_tier[term]=current_index[term]
            else:
                third_tier[term]=current_index[term]
